    ...
    >
      ...
      <div className="cta-aww-marquee cta-aww-marquee-top">
        <div className="cta-aww-marquee-track">
          {Array(10).fill(null).map((_, i) => (
            <span key={i} className="cta-aww-marquee-item">Zbudujmy coś wielkiego</span>
          ))}
        </div>
      </div>
      ...
      <div className="cta-aww-content">
        ...
        <div className="cta-aww-label">
          <span className="cta-aww-label-text">Gotowy?</span>
          <span className="cta-aww-label-ghost" aria-hidden="true">Gotowy?</span>
        </div>
        ...
        <div className="cta-aww-or">
          ...
          <span className="cta-aww-or-text">lub</span>
          <span className="cta-aww-or-line" />
        </div>

        {/* CTA Button */}
        <Link href="/pl/contact" className="cta-aww-btn">
          <span className="cta-aww-btn-bg" />
          <span className="cta-aww-btn-text">Rozpocznij projekt</span>
      ...
      <div className="cta-aww-marquee cta-aww-marquee-bottom">
        <div className="cta-aww-marquee-track cta-aww-marquee-reverse">
          {Array(10).fill(null).map((_, i) => (
            <span key={i} className="cta-aww-marquee-item">Dostępny w Q1 2026</span>
          ))}
        </div>
      </div>
