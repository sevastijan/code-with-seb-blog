...
Welcome to my blog! My name is Sebastian Ślęczka, and I'm a passionate frontend technology enthusiast with almost 10 years of experience in the industry. Today, I'd like to share my professional journey and the most important lessons I've learned along the way.

## Beginnings Aren't Always Easy

My programming adventure started quite modestly - creating websites for Counter-Strike 1.6 clans and designing auction templates for Allegro (Polish eBay equivalent). These were my first steps in the world of HTML and CSS, long before React or even jQuery became the standard. However, it wasn't until 2016, when I joined E NET Production as a Frontend Developer, that I truly immersed myself in the world of modern web interfaces.
...
1. **Mobile Service** - an iOS application in React Native supporting electronics service technicians
2. **Accomore** - a reservation system for apart-hotels with Booking API integration
3. **Anonymous Surveillance** - an optimized application for database management
4. **MoodBeat Analytics** - my latest project (01/2025), analyzing user mood based on voice recordings

I'm particularly excited about the "mono services architecture" concept in MoodBeat Analytics, which I plan to present on my YouTube channel. It combines the advantages of a monorepo with microservices, using Java 17, Spring, NuxtJS, and Tailwind.
